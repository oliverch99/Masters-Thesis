...
def collect_daily_data(df = read_csv("data.csv"), from_date = '01/11/2021', to_date = '1/1/2022'):
    """
...
collect_daily_data(df = "wallstreetbets_submissions.csv",from_date = '13/03/2024', to_date = '14/03/2024')